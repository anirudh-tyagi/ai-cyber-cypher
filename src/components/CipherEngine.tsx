  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-4 sm:space-y-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 sm:gap-4 @container">
          <div>
          ...
          <div>
            ...
            <div className="flex gap-2 w-full">
              <Button
                ...
                size="sm"
              >
                <Lock className="w-3 h-3 mr-1 sm:w-4 sm:h-4 sm:mr-2" />
                <span className="text-xs sm:text-sm">Encrypt</span>
              </Button>
              <Button
                ...
                size="sm"
              >
                <Unlock className="w-3 h-3 mr-1 sm:w-4 sm:h-4 sm:mr-2" />
                <span className="text-xs sm:text-sm">Decrypt</span>
              </Button>
            </div>
          </div>
        </div>
        ...
        >
          {isProcessing ? (
            ...
            <>
              ...
              <span className="text-sm">{cipherState.mode === 'encrypt' ? 'Encrypt' : 'Decrypt'} Text</span>
            </>
          )}
        </Button>
